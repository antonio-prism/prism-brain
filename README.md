...
- **900 Risk Events** across 4 domains (Physical, Structural, Operational, Digital)
- **1,921 Business Processes** from the APQC Process Classification Framework
...
- Browse 900 risk events sorted by relevance
- Select risks to include in assessment
- System highlights Super Risks for attention
...
├── data/
│   ├── risk_database.json          # 900 risk events
