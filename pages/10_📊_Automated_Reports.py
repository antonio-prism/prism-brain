...
with tab1:
    ...
    try:
        with st.form("generate_report_form", clear_on_submit=False):
            ...
            gc, cc = st.columns(2)
            with gc:
                generate_btn = st.form_submit_button("ð Generate Report", use_container_width=True, type="primary")
            with cc:
    ...
    with col_create:
        ...
        try:
            ...
            with st.form("create_schedule_form", clear_on_submit=False):
                ...
                submit_btn = st.form_submit_button("Create Schedule", use_container_width=True, type="primary")
                if submit_btn:
